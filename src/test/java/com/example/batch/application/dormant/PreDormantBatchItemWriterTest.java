...
class PreDormantBatchItemWriterTest {
    ...
    void test1() {
        ...
        final Customer c1 = new Customer("c1", "c1@naver.com");

        // when
        preDormantBatchItemWriter.write(c1);

        // then
        verify(mockEmailProvider, atLeast(1)).send(any(), any(), any()); // send()가 적어도 한 번 호출되었는지 확인
